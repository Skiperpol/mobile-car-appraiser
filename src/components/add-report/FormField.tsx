...
export function FormField({
    ...
    return (
      <View className="mb-4">
        ...
        <TextInput
          ...
          className="h-24 w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-lg text-zinc-900"
  ...
  return (
    <View className="mb-4">
      <Text className="mb-2 text-[16px] text-zinc-700">{label}</Text>
      <Input
        className="h-14 rounded-xl border-zinc-200 bg-zinc-50 px-4 text-lg"
        placeholderTextColor="#a1a1aa"
        {...props}
      />
      {errorMessage ? (
